...
//     const addCall =
//       newNames.length > 0
//         ? this.http.post(`${API_BASE}/items/${itemId}/tags`, { tagNames: newNames }, { headers: this.buildHeaders() })
//         : of(null);
...
//     const attributes = this.draftAttrs.map((a) => ({
...
//     const upsertCall =
//       attributes.length > 0
//         ? this.http.post(`${API_BASE}/items/${itemId}/attributes`, { attributes }, { headers: this.buildHeaders() })
//         : of(null);
